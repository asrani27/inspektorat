	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-3">
                ...
                <form class="form-horizontal form-bordered" method="POST" action="/kelola_user/{{$data->id}}/update">
                        @csrf
                        <div class="form-group row">
							<label class="col-md-4 col-form-label">Nama Pengguna</label>
							<div class="col-md-8">
                            <input class="form-control" type="text" name="nama" required value="{{$data->name}}"/>
							</div>
                        </div>
                        <div class="form-group row">
							<label class="col-md-4 col-form-label">Username</label>
							<div class="col-md-8">
                                <input class="form-control" type="text" name="username" readonly value="{{$data->username}}"/>
							</div>
                        </div>
                        <div class="form-group row">
