		...
		<div class="col-lg-12">
			...
			<div class="panel panel-inverse">
				...
				<div class="form-group row">
					...
					<div class="col-md-1">
						<a href="/pencanangan/kategori/{{$id_kategori}}" class="btn btn-danger">Kembali</a>
					</div>
					<div class="col-md-2">
				...
				<form method="POST" action="/pencanangan/kategori/{{$id_kategori}}/upload" enctype="multipart/form-data">
                    @csrf
