...
<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="panel panel-inverse">
                ...
                <h4 class="panel-title">WBBM - {{strtoupper($skpd->nama)}}</h4>
				</div>
				<!-- end panel-heading -->
				<!-- begin alert -->
							...
							<tr class="odd gradeX">
                                ...
                                <td>
									...
									@else
                                        ...
                                        <a href="/skpd/filewbbm/delete/{{$item->upload_id}}" class="btn btn-xs btn-danger" onclick="return confirm('Apakah anda Yakin ingin menghapus Data Ini?');">Delete</a> 	
                                        @endif
									@endif
                                </td>
							</tr>
...
<div class="modal fade" id="modal-dialog">
		<div class="modal-dialog">
			<div class="modal-content">
                ...
                <form action="/skpd/wbbm" method="POST" enctype="multipart/form-data">
					@csrf
...
<div class="modal fade" id="modal-dialog-edit-file">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/skpd/filewbbm/update" method="POST" enctype="multipart/form-data">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
