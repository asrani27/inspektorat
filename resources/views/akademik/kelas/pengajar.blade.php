	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-3">
                ...
                <form class="form-horizontal form-bordered" method="POST" action="/perkuliahan/prodi/{{$id_prodi}}/pengajar/{{$id_kelas}}/simpan">
                        @csrf
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label">Nama Mata Kuliah</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" readonly value="{{$data['kode_mata_kuliah']}} {{$data['nama_mata_kuliah']}}"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label">Nama Kelas</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" readonly value="{{$data['nama_kelas_kuliah']}}"/>
                            </div>
                        </div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
                              <input class="form-control" type="text" name="tatap_muka" required/>
							</div>
                        </div>
						<div class="form-group row">
